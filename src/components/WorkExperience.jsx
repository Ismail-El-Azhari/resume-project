...
function WorkExperience(){
  ...
  return(
    ...
    <div class="section-example">
      ...
      <div> 
        <button class="website-button" onClick ={() => handleButtonClick("https://www.brp.com")}>BRP website</button>
      </div>
      <div>
        <button class="video-button" onClick={() => handleButtonClick("https://youtu.be/KwKCG26S5WM")}>Video representation (in French)</button>
      </div>
    </div>
    <div class="section-example">
    ...
    <h4>Rogers Inc.</h4>
      ...
      <button class="website-button" onClick={() => handleButtonClick("https://www.rogers.com")}>Rogers website</button>
    </div>
    <div class="section-example">
      <h3>Customer  service  representative</h3>
      <h4>Voxdata</h4>
        ...
        <button class="website-button" onClick={() => handleButtonClick("https://www.voxdata.com")}>Voxdata website</button>
    </div>
  </div>
